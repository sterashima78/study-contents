...
export const triangleSimilarityConditionsLesson: MathLesson = {
  ...
  concepts: [
    {
      title: "三角形を決める三つの条件",
      body: ["対応する3組の辺の比、2組の辺の比とその間の角、2組の角のいずれかがそろえば二つの三角形は相似です。", "合同条件では辺の長さが等しいことを使いましたが、相似条件では辺の比を使います。"],
  ...
  practice: {
    ...
    steps: [
      { prompt: "対応する2組の角がそれぞれ等しいとき使う相似条件を答えてください。", answers: ["2組の角", "二組の角", "2組の角がそれぞれ等しい"], placeholder: "条件" },
      { prompt: "3辺が3,4,5と6,8,10の三角形は相似ですか。", answers: ["はい", "相似", "相似です"], placeholder: "はい/いいえ" },
    ],
