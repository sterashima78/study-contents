...
export const pythagoreanApplicationLesson: MathLesson = {
  ...
  goals: ["具体的な事象に必要な直角三角形を見いだせる。", "根号の値を場面に応じて近似し、結果を解釈できる。"],
  concepts: [
    {
      title: "現実を直角三角形としてモデル化する",
      body: ["水平距離と高さの差が分かれば、斜めの実距離を直角三角形の斜辺として求められます。", "現実を理想化・単純化した結果であることを確認し、必要な精度で近似値を使います。"],
  ...
  practice: {
    ...
    steps: [
      { prompt: "水平距離30m、高さの差40mの2地点間の直線距離を答えてください。", answers: ["50", "50m"], placeholder: "距離" },
      { prompt: "一辺10cmの正方形の対角線を根号で答えてください。", answers: ["10√2", "10√2cm"], placeholder: "長さ" },
    ],
    hint: "求めたい線分を斜辺にする直角三角形を探します。",
  },
  summary: ["直接測れない距離も直角三角形に単純化して求められる。", "平方根は場面に応じて近似値へ直して解釈する。"],
};
