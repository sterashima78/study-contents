...
export const similarityApplicationLesson: MathLesson = {
  ...
  goals: [
    "具体的な場面から相似な三角形を見いだせる。",
    "相似比を用いて直接測れない量を求められる。",
  ],
  concepts: [
    {
      title: "測れる量から測れない量へ",
      body: [
        "同じ時刻の物体と影では太陽光の向きがほぼ平行なので、高さと影から相似な直角三角形を作れます。",
        "現実の事象を単純化したことを意識し、得た値が近似的な推定である場合も確認します。",
      ],
  ...
  practice: {
    ...
    steps: [
      {
        prompt: "高さ2mの棒の影が3m、塔の影が12mのとき塔の高さを答えてください。",
        answers: ["8", "8m"],
        placeholder: "高さ",
      },
      {
        prompt: "縮尺1:500の図で4cmの距離は実際には何mですか。",
        answers: ["20", "20m"],
        placeholder: "距離",
      },
    ],
