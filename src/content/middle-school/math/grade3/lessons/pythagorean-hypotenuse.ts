...
export const pythagoreanHypotenuseLesson: MathLesson = {
  ...
  concepts: [
    {
      title: "最後に正の平方根を取る",
      body: ["長さを求めるので、c²の値を求めた後は正の平方根を取ります。", "平方根の単元で学んだ根号の簡単化が、図形の計量に直接つながります。"],
      formulas: ["c=√(a²+b²)"],
    },
  ],
  example: {
  ...
  practice: {
    ...
    steps: [
      { prompt: "直角をはさむ2辺が6cmと8cmのとき斜辺を答えてください。", answers: ["10", "10cm"], placeholder: "長さ" },
      { prompt: "直角をはさむ2辺が1cmと2cmのとき斜辺を根号で答えてください。", answers: ["√5", "√5cm"], placeholder: "長さ" },
    ],
