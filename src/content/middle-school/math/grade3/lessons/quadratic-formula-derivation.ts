...
export const quadraticFormulaDerivationLesson: MathLesson = {
  ...
  description: "平方完成の手順を一般のax²+bx+c=0へ広げ、解の公式が同じ操作の反復をまとめたものだと捉えます。",
  goals: [
  ...
  example: {
    ...
    steps: [
      ...
      { expression: "x=(-4±√(4²−4·1·(−7)))/2", note: "解の公式へa=1、b=4、c=−7を入れても同じ結果です。" },
    ],
  },
  practice: {
    ...
    steps: [
      { prompt: "x²+6x−2=0を(x+3)²=kの形にするとき、kを答えてください。", answers: ["11"], placeholder: "k" },
      { prompt: "ax²+bx+c=0の解の公式の分母を答えてください。", answers: ["2a", "2*a", "2×a"], placeholder: "式" },
    ],
