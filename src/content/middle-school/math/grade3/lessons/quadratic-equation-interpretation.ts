...
export const quadraticEquationInterpretationLesson: MathLesson = {
  ...
  description:
    "得られた二つの解を元の事象に戻し、長さや個数などの条件に合う解だけを答えとして採用します。",
  goals: [
    "二次方程式の解と問題の答えを区別できる。",
  ...
  practice: {
    ...
    steps: [
      {
        prompt: "正方形の1辺x cmについてx²=36を得ました。問題の答えとなる長さを答えてください。",
        answers: ["6", "6cm", "6cmです"],
        placeholder: "長さ",
      },
      {
        prompt:
          "連続する正の整数をx、x+1とし、積が72です。x²+x−72=0の解が8と−9のとき、小さい方の整数を答えてください。",
        answers: ["8"],
        placeholder: "整数",
      },
    ],
