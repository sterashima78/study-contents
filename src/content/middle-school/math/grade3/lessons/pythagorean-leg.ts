...
export const pythagoreanLegLesson: MathLesson = {
  ...
  concepts: [
    {
      title: "斜辺の平方から引く",
      body: [
        "a²+b²=c²をbについて見ればb²=c²−a²です。",
        "最長辺が斜辺であることを確認してから式を立てると、引く向きを誤りにくくなります。",
      ],
      formulas: ["b=√(c²−a²)"],
    },
  ],
  ...
  practice: {
    ...
    steps: [
      {
        prompt: "斜辺10cm、1辺6cmの直角三角形で残りの辺を答えてください。",
        answers: ["8", "8cm"],
        placeholder: "長さ",
      },
      {
        prompt: "斜辺5cm、1辺2cmの直角三角形で残りの辺を根号で答えてください。",
        answers: ["√21", "√21cm"],
        placeholder: "長さ",
      },
    ],
