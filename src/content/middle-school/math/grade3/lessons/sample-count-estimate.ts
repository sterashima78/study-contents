...
export const sampleCountEstimateLesson: MathLesson = {
  ...
  concepts: [
    {
      title: "割合×全体で個数を見積もる",
      body: [
        "標本から母集団の割合をpと推定したら、母集団の大きさNにpを掛けて該当数を見積もれます。",
        "標本調査からの値なので、必要以上に細かい桁まで確定値のように扱わないことが大切です。",
      ],
  ...
  practice: {
    ...
    steps: [
      {
        prompt: "母集団2000個、推定割合15%のとき該当数をおよそ何個と推定しますか。",
        answers: ["300", "300個"],
        placeholder: "個数",
      },
      {
        prompt: "母集団800人、推定割合0.25のとき該当人数をおよそ何人と推定しますか。",
        answers: ["200", "200人"],
        placeholder: "人数",
      },
    ],
