...
export const circleAngleApplicationLesson: MathLesson = {
  ...
  goals: ["直径に対する円周角が直角になることを使える。", "円周角の性質を具体的な作図・測定に結び付けられる。"],
  concepts: [
    {
      title: "直角を円から作る",
      body: ["直径OPに対する円周角∠OQPは90°です。これを利用すると、円の外部の点Pから接点Qを決める作図を考えられます。", "円周角の性質は、丸い物体の中心や直径を見積もる場面にも利用できます。"],
  ...
  practice: {
    ...
    steps: [
      { prompt: "直径ABに対する円周角∠APBは何度ですか。", answers: ["90", "90°"], placeholder: "角度" },
      { prompt: "円の接線と接点を通る半径はどんな位置関係ですか。", answers: ["垂直", "垂直です", "直角"], placeholder: "位置関係" },
    ],
