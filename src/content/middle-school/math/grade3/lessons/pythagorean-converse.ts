...
export const pythagoreanConverseLesson: MathLesson = {
  ...
  concepts: [
    {
      title: "辺の長さから直角を判断する",
      body: ["三角形の3辺をa≤b<cとするときa²+b²=c²なら、その三角形は直角三角形です。", "元の定理は直角から辺の関係、逆は辺の関係から直角を導きます。"],
  ...
  practice: {
    ...
    problem: "最長辺を最後に置きます。",
    steps: [
      { prompt: "辺の長さが5,12,13の三角形は直角三角形ですか。", answers: ["はい", "直角三角形", "直角三角形です"], placeholder: "はい/いいえ" },
      { prompt: "辺の長さが4,5,6の三角形は直角三角形ですか。", answers: ["いいえ", "直角三角形ではない", "直角三角形ではありません"], placeholder: "はい/いいえ" },
    ],
