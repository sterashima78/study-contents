...
export const sampleProportionEstimateLesson: MathLesson = {
  ...
  concepts: [
    {
      ...
      body: ["無作為に抽出した標本である特徴をもつ割合がpなら、母集団でもその割合がpに近いと推定します。", "推定値は完全に一致するとは限らず、標本の取り方や大きさに左右されます。"],
  ...
  practice: {
    ...
    steps: [
      { prompt: "無作為標本150人中90人が賛成なら、標本の賛成割合を%で答えてください。", answers: ["60", "60%", "60％"], placeholder: "%" },
      { prompt: "無作為標本の賛成割合が0.72なら、母集団の賛成割合をおよそ何%と推定しますか。", answers: ["72", "72%", "72％"], placeholder: "%" },
    ],
    hint: "割合=該当数÷標本数です。",
  },
