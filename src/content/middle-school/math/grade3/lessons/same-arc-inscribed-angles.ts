...
export const sameArcInscribedAnglesLesson: MathLesson = {
  ...
  goals: ["同じ弧に対する円周角が等しい理由を説明できる。", "円周上の点が変わっても同じ弧なら角が等しいことを使える。"],
  concepts: [
    {
      title: "同じ中心角の半分だから等しい",
      body: ["同じ弧ABに対する円周角∠APBと∠AQBは、どちらも中心角∠AOBの半分です。", "したがって点P、Qの位置が違っても∠APB=∠AQBです。"],
  ...
  practice: {
    ...
    steps: [
      { prompt: "同じ弧ABに対する円周角が28°のとき、別の円周角も何度ですか。", answers: ["28", "28°"], placeholder: "角度" },
      { prompt: "直径ABに対する円周角を答えてください。", answers: ["90", "90°", "直角"], placeholder: "角度" },
    ],
