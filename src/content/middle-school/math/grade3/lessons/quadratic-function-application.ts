...
export const quadraticFunctionApplicationLesson: MathLesson = {
  ...
  description:
    "実験や身近な事象を2乗比例とみなし、表・式・グラフから値を予測して妥当性を考えます。",
  goals: [
    "事象をy=ax²とみなすための根拠を説明できる。",
    "モデルから値を予測し、適用範囲を考えられる。",
  ],
  concepts: [
    {
      title: "理想化・単純化してモデルを作る",
      body: [
        "実測値が完全には一致しなくても、y/x²がほぼ一定ならy=ax²とみなして考えることがあります。",
        "予測と実測の食い違いを確認し、どの範囲でモデルが役立つか考えることも重要です。",
      ],
  ...
  practice: {
    ...
    steps: [
      {
        prompt: "y=3x²というモデルでx=4のときyを答えてください。",
        answers: ["48"],
        placeholder: "y",
      },
      {
        prompt: "xを2倍にすると、このモデルのyは何倍になりますか。",
        answers: ["4", "4倍"],
        placeholder: "倍率",
      },
    ],
  ...
  summary: [
    "実データを理想化してy=ax²とみなすことがある。",
    "予測値はモデルの前提と適用範囲とともに解釈する。",
  ],
};
