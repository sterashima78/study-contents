...
export const quadraticFunctionRateLesson: MathLesson = {
  ...
  concepts: [
    {
      title: "曲線だから傾き方が変わる",
      body: [
        "変化の割合は(y₂−y₁)/(x₂−x₁)で求めます。",
        "y=ax²では区間によってこの値が変わり、一次関数のように一定ではないためグラフは直線になりません。",
      ],
  ...
  practice: {
    ...
    steps: [
      {
        prompt: "y=x²でxが2から3まで変化するときの変化の割合を答えてください。",
        answers: ["5"],
        placeholder: "変化の割合",
      },
      {
        prompt: "y=ax²の変化の割合は一般に一定ですか。",
        answers: ["いいえ", "一定ではない", "一定でない"],
        placeholder: "はい/いいえ",
      },
    ],
    hint: "yの増加量÷xの増加量です。",
