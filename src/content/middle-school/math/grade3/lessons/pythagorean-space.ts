...
export const pythagoreanSpaceLesson: MathLesson = {
  ...
  goals: [
    "空間図形から必要な直角三角形を取り出せる。",
    "三平方の定理を2段階で使って空間の長さを求められる。",
  ],
  concepts: [
    {
      title: "一度に考えず、面の対角線から",
      body: [
        "直方体の空間対角線は、まず底面の対角線を求め、その対角線と高さでできる直角三角形に三平方の定理をもう一度使います。",
        "見えにくい直角三角形を補助線で作ることが重要です。",
      ],
  ...
  practice: {
    ...
    steps: [
      {
        prompt: "縦1、横2、高さ2の直方体の空間対角線を答えてください。",
        answers: ["3"],
        placeholder: "長さ",
      },
      {
        prompt: "縦2、横3、高さ6の直方体の空間対角線を答えてください。",
        answers: ["7"],
        placeholder: "長さ",
      },
    ],
