...
export const inscribedCentralAngleLesson: MathLesson = {
  ...
  concepts: [
    {
      title: "円周角は中心角の半分",
      body: [
        "同じ弧ABに対する中心角∠AOBと円周角∠APBを比べると、円周角は中心角の半分です。",
        "この関係は点Pの位置を円周上で動かしても、同じ弧を見る限り変わりません。",
      ],
  ...
  practice: {
    ...
    steps: [
      {
        prompt: "中心角が100°のとき、同じ弧に対する円周角を答えてください。",
        answers: ["50", "50°"],
        placeholder: "角度",
      },
      {
        prompt: "円周角が35°のとき、同じ弧に対する中心角を答えてください。",
        answers: ["70", "70°"],
        placeholder: "角度",
      },
    ],
