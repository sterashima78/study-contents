...
function samplingFlowScene(): DiagramScene {
  return {
    ...
    height: 300,
    ariaLabel:
      "大きな母集団から一部の標本を無作為に抽出し、標本の結果から母集団の傾向を推定する流れを示す模式図。",
...
function biasedSamplingScene(): DiagramScene {
  return {
    ...
    height: 300,
    ariaLabel:
      "母集団の中の異なるグループのうち一部のグループからだけ標本を選ぶと偏りが生じることを示す模式図。",
    responsive: { minWidth: 470, allowHorizontalScroll: true },
    elements: [
      {
        kind: "polygon",
        points: [point(55, 55), point(320, 55), point(320, 245), point(55, 245)],
        color: BLUE,
      },
