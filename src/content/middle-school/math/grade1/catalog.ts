    ...
    units: [
      {
        ...
        lessons: [positiveNegativeMeaningLesson, numberLineAbsoluteValueLesson, additionLesson, subtractionLesson, multiplicationLesson, divisionLesson],
      },
      {
        key: "literal-expressions",
        title: "文字と式",
        description: "文字で数量を一般的に表し、表記・代入・一次式の加減・数量関係の表現を学びます。",
        lessons: [lettersMeaningLesson, multiplicationNotationLesson, divisionNotationLesson, substitutionValueLesson, termsCoefficientsLesson, combineLikeTermsLesson, linearExpressionAdditionSubtractionLesson, expressRelationsLesson],
      },
      {
        key: "linear-equations",
        title: "一元一次方程式",
        description: "方程式と解の意味から、等式の性質、移項、比例式、文章題への活用まで段階的に学びます。",
        lessons: [equationMeaningLesson, equalityPropertiesLesson, equationAddSubtractLesson, equationMultiplyDivideLesson, transpositionLesson, equationBothSidesLesson, proportionEquationsLesson, equationWordProblemsLesson],
      },
    ],
  },
  {
    ...
    units: [
      {
        key: "plane-geometry",
        title: "平面図形",
        description: "定規とコンパスによる基本作図と図形の移動を、図形の性質や対応点と結び付けて学びます。",
        lessons: [constructionSymmetryLesson, angleBisectorConstructionLesson, perpendicularBisectorConstructionLesson, perpendicularConstructionLesson, translationLesson, reflectionLesson, rotationLesson, tangentConstructionApplicationLesson],
      },
    ],
  },
  {
    ...
    units: [
      {
        ...
        title: "比例・反比例",
        description: "関数関係の意味から、比例・反比例の式とグラフ、表・式・グラフを用いた活用まで学びます。",
        lessons: [functionMeaningLesson, variablesDomainLesson, proportionTableExpressionLesson, coordinatesLesson, proportionGraphLesson, inverseProportionTableExpressionLesson, inverseProportionGraphLesson, functionRepresentationsApplicationLesson],
      },
    ],
  },
];
