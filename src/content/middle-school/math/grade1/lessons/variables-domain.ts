...
export const variablesDomainLesson: MathLesson = {
  ...
  concepts: [
    {
      ...
      body: [
        ...
        "変域は 0 ≤ x ≤ 5 のような不等式で表せます。数直線のグラフでは、0から5までの区間を示すことで、最小値・最大値と端の値を含むことを視覚的に確認できます。",
      ],
  ...
  example: {
    ...
    steps: [
      ...
      {
        expression: "0 ≤ x ≤ 5",
        note: "0分以上5分以下が x の変域です。数直線では0から5までを結び、0と5も含むことを端点で確かめます。",
      },
    ],
  },
  practice: {
  ...
  summary: [
    ...
    "変域は不等式だけでなく数直線のグラフでも表し、区間と端点を確認できる。",
  ],
};
