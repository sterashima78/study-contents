...
function relativeFrequencyScene(): DiagramScene {
  return {
    ...
    elements: [
      {
        kind: "polygon",
        points: [point(85, 245), point(195, 245), point(195, 125), point(85, 125)],
        color: BLUE,
      },
      {
        kind: "polygon",
        points: [point(300, 245), point(410, 245), point(410, 85), point(300, 85)],
        color: ORANGE,
      },
...
function cumulativeFrequencyScene(): DiagramScene {
  ...
  return {
    ...
    elements: [
      ...
      ...x.map((xValue, index) =>
        label(point(xValue, y[index] - 18), String(values[index]), GREEN),
      ),
...
function critiqueScene(): DiagramScene {
  return {
    ...
    elements: [
      ...
      {
        kind: "polygon",
        points: [point(55, 250), point(85, 250), point(85, 190), point(55, 190)],
        color: BLUE,
      },
      {
        kind: "polygon",
        points: [point(85, 250), point(115, 250), point(115, 115), point(85, 115)],
        color: ORANGE,
      },
      {
        kind: "polygon",
        points: [point(115, 250), point(145, 250), point(145, 155), point(115, 155)],
        color: BLUE,
      },
      {
        kind: "polygon",
        points: [point(145, 250), point(175, 250), point(175, 105), point(145, 105)],
        color: ORANGE,
      },
      {
        kind: "polygon",
        points: [point(175, 250), point(205, 250), point(205, 195), point(175, 195)],
        color: BLUE,
      },
      { kind: "segment", from: point(270, 250), to: point(460, 250), color: BASE },
      {
        kind: "polygon",
        points: [point(290, 250), point(355, 250), point(355, 105), point(290, 105)],
        color: GREEN,
      },
      {
        kind: "polygon",
        points: [point(355, 250), point(420, 250), point(420, 130), point(355, 130)],
        color: GREEN,
      },
...
function predictionScene(): DiagramScene {
  return {
    ...
    elements: [
      {
        kind: "polygon",
        points: [point(55, 225), point(180, 225), point(180, 105), point(55, 105)],
        color: BLUE,
      },
      { kind: "arrow", from: point(205, 165), to: point(285, 165), color: PURPLE },
      {
        kind: "polygon",
        points: [point(310, 225), point(435, 225), point(435, 85), point(310, 85)],
        color: ORANGE,
      },
