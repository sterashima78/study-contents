...
function parallelAnglesScene(): DiagramScene {
  return {
    width: 520,
    height: 340,
    ariaLabel: "平行な2直線lとmを斜めの直線tが横切り、同位角と錯角の位置を色分けして示す図。",
...
function polygonScene(): DiagramScene {
  ...
  return {
    width: 520,
    height: 350,
    ariaLabel: "五角形の一つの頂点から対角線を2本引き、3つの三角形に分割して内角の和を考える図。",
    responsive: { minWidth: 440, allowHorizontalScroll: true },
    elements: [
...
function congruenceScene(): DiagramScene {
  ...
  return {
    width: 520,
    height: 340,
    ariaLabel: "同じ形と大きさの三角形ABCとDEFを並べ、対応する頂点と辺を同じ色で示す合同の図。",
    responsive: { minWidth: 440, allowHorizontalScroll: true },
    elements: [
...
function specialQuadrilateralsScene(): DiagramScene {
  return {
    ...
    elements: [
      {
        kind: "polygon",
        points: [point(55, 55), point(465, 55), point(465, 285), point(55, 285)],
        color: BLUE,
      },
      {
        kind: "polygon",
        points: [point(90, 105), point(270, 105), point(270, 245), point(90, 245)],
        color: GREEN,
      },
      {
        kind: "polygon",
        points: [point(250, 105), point(430, 105), point(430, 245), point(250, 245)],
        color: ORANGE,
      },
      {
        kind: "polygon",
        points: [point(225, 145), point(300, 145), point(300, 220), point(225, 220)],
        color: PURPLE,
      },
...
const diagrams: Record<string, MathLessonDiagrams> = {
  "vertical-corresponding-alternate": {
    rule: parallelAnglesScene(),
    example: parallelAnglesScene(),
  },
