    ...
    lessons: [
      {
        ...
        goals: [
          "a の符号から上に開くか下に開くか判断できる。",
          "a の絶対値とグラフの広がりの関係を説明できる。",
        ],
        concepts: [
          {
            title: "原点を頂点とする放物線",
      ...
      },
      {
        ...
        goals: [
          "頂点 (p,q) と軸 x=p を式から読める。",
          "y=ax² からの平行移動としてグラフを説明できる。",
        ],
        concepts: [
          {
            title: "かっこの中は符号を逆に読む",
      ...
      },
      {
        ...
        goals: [
          "x²+bx の部分を完全平方にできる。",
          "一般形から頂点形式へ途中式を追って変形できる。",
        ],
        concepts: [
          {
            title: "x の係数の半分を使う",
            body: [
              "x²+bx では、b/2 を使って (x+b/2)² を作ります。追加した平方分は同じ式の中で引いて値を保ちます。",
            ],
    ...
    lessons: [
      {
        ...
        goals: [
          "a の符号から最大・最小のどちらをもつか判断できる。",
          "頂点の y 座標を最大値・最小値として読める。",
        ],
        concepts: [
          {
            title: "頂点が極値を与える",
            body: [
              "y=a(x−p)²+q では (x−p)²≥0 です。a>0 なら a(x−p)²≥0 なので y≥q、a<0 なら y≤q です。",
            ],
      ...
      },
      {
        ...
        goals: [
          "頂点が定義域に含まれるか判断できる。",
          "端点と頂点の候補を比較して最大・最小を決められる。",
        ],
        concepts: [
          {
            title: "候補は頂点と端点",
            body: [
              "区間に制限があると、頂点が範囲外の場合があります。まず軸 x=p と定義域の位置関係を見ます。",
              "頂点が範囲内なら頂点と両端、範囲外なら両端の値を比較します。",
            ],
          },
        ],
        example: {
        ...
        practice: {
          ...
          steps: [
            ...
            {
              prompt: "最大値と最小値を『最大,最小』の順に書いてください。",
              answers: ["5,1", "5，1"],
            },
          ],
        ...
        summary: [
          "定義域が区間なら、頂点の位置を最初に確認する。",
          "最大・最小は端点と範囲内の頂点を比較して決める。",
        ],
      },
      {
        ...
        goals: [
          "文章から二次関数と定義域を作れる。",
          "最大・最小の結果を問題の意味に戻して答えられる。",
        ],
        concepts: [
          {
            title: "式より先に変数と範囲を決める",
            body: [
              "長さや個数を x と置いたら、負にならないなど現実の条件から定義域を決めます。",
              "作った二次関数を平方完成し、数学上の最大・最小が実際の範囲でも使えるか確認します。",
            ],
          },
        ],
        example: {
        ...
        practice: {
          ...
          steps: [
            {
              prompt: "積 P を x の式で書いてください。",
              answers: ["x(12-x)", "-x²+12x", "−x²+12x"],
            },
        ...
        summary: [
          "文章題では変数の定義域を必ず書く。",
          "最大・最小を求めた後、元の数量として意味のある答えか確認する。",
        ],
      },
    ],
  },
    ...
    lessons: [
      {
        ...
        concepts: [
          {
            title: "x軸上では y=0",
            body: [
              "y=f(x) のグラフがx軸と交わる点では y=0 です。したがって f(x)=0 を解けば交点の x 座標が分かります。",
            ],
            formulas: ["f(x)=0 の解 ⇔ y=f(x) と x軸の交点の x 座標"],
          },
        ],
        example: {
        ...
        practice: {
          ...
          steps: [
            {
              prompt: "y=0 とした方程式を因数分解してください。",
              answers: ["(x+3)(x-2)=0", "(x-2)(x+3)=0"],
            },
      ...
      },
      {
        ...
        concepts: [
          {
            title: "一般の二次方程式を平方完成する",
            body: ["a≠0 とし、まず a で割って x² の係数を1にしてから平方完成します。"],
        ...
        example: {
          ...
          steps: [
            {
              expression: "x = (3 ± √((−3)²−4·2·(−1)))/(2·2)",
              note: "−b=3 であることに注意します。",
            },
        ...
        summary: [
          "解の公式は平方完成を一般の係数で行った結果。",
          "b の符号と 2a の分母を特に確認する。",
        ],
      },
      {
        key: "discriminant",
        ...
        goals: [
          "D=b²−4ac の符号から実数解の個数を判断できる。",
          "解の個数をx軸との交点の個数として説明できる。",
        ],
        concepts: [
          {
            title: "平方根の中が実数解を決める",
            body: [
              "解の公式では √D が現れます。D>0なら異なる2実数解、D=0なら重解1つ、D<0なら実数解なしです。",
            ],
            formulas: ["D = b² − 4ac", "D>0: 2実数解, D=0: 重解, D<0: 実数解なし"],
          },
        ],
        example: {
    ...
    lessons: [
      {
        ...
        goals: [
          "二次方程式の2解を境界として求められる。",
          "a の符号から正負になる区間を判断できる。",
        ],
        concepts: [
          {
            title: "まず =0 の境界を求める",
            body: [
              "f(x)>0 や f(x)<0 を考えるとき、先に f(x)=0 の解を求めます。",
              "a>0 の放物線なら2根の外側で正、内側で負です。a<0 なら逆になります。",
            ],
          },
        ],
        example: {
          ...
          steps: [
            ...
            {
              expression: "a=1>0 なので2と3の間で y<0",
              note: "上に開く放物線は2交点の間でx軸より下です。",
            },
        ...
        practice: {
          ...
          steps: [
            {
              prompt: "境界となる2つの解を書いてください。",
              answers: ["-3,2", "−3,2", "2,-3", "2,−3"],
            },
            {
              prompt: "不等式の解を書いてください。",
              answers: ["x≤-3,x≥2", "x≤−3,x≥2", "x≤-3またはx≥2", "x≤−3またはx≥2"],
            },
          ],
          hint: "上に開くので0以上になるのは2根の外側です。≥ なので根も含みます。",
        },
        summary: [
          "二次不等式は =0 の解を境界としてグラフの符号を読む。",
          "上に開く場合は外側が正、内側が負。",
        ],
      },
      {
        ...
        goals: [
          "重解のとき符号が根の両側で変わらないことを説明できる。",
          "実数解がない場合に式全体の符号を判断できる。",
        ],
        concepts: [
          {
            title: "交点がないと符号は変わらない",
            body: [
              "放物線がx軸と交わらなければ、連続したグラフはずっとx軸の同じ側にあります。",
              "a>0 で D<0 なら常に正、a<0 で D<0 なら常に負です。重解では接点だけ0になります。",
            ],
          },
        ],
        example: {
        ...
        summary: [
          "重解では接するだけなので符号は根の前後で変わらない。",
          "実数解なしなら a の符号から二次式全体の符号を判断できる。",
        ],
      },
      {
        ...
        goals: [
          "文章の条件を積や面積の二次不等式にできる。",
          "数学上の解と現実の定義域の共通部分を答えられる。",
        ],
        concepts: [
          {
            title: "最後に定義域と交わす",
            body: [
              "文章題では x が長さや個数を表すため、二次不等式の解をそのまま答えられないことがあります。",
              "最初に定義域を書き、最後に不等式の解との共通部分を取ります。",
            ],
          },
        ],
        example: {
        ...
        practice: {
          ...
          steps: [
            {
              prompt: "整理した二次不等式を書いてください。",
              answers: ["x²-12x+32≤0", "x²−12x+32≤0"],
            },
