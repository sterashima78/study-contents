...
const additionalFormulaDerivations: Record<string, FormulaDerivation> = {
  "special-angle-trig": {
    ...
    steps: [
      {
        expression: "45°: 1² + 1² = (斜辺)²",
        note: "2辺が1の直角二等辺三角形に三平方の定理を使います。",
      },
      {
        expression: "斜辺 = √2 → sin45° = cos45° = 1/√2, tan45° = 1",
        note: "三角比の定義へ辺の比 1:1:√2 を入れます。",
      },
      {
        expression: "30°・60°: 一辺2の正三角形を高さで半分にする",
        note: "斜辺2、短い辺1の直角三角形ができます。",
      },
      { expression: "高さ² = 2² − 1² = 3 → 高さ = √3", note: "辺の比は 1:√3:2 です。" },
      {
        expression: "sin30°=1/2, cos30°=√3/2, sin60°=√3/2, cos60°=1/2",
        note: "三角比の定義へ辺の比を入れると特別な角の値が得られます。",
      },
    ],
  },
  "obtuse-angle-trig": {
    ...
    steps: [
      {
        expression: "θ の点を (cosθ, sinθ) とする",
        note: "単位円では x座標が cos、y座標が sin です。",
      },
      {
        expression: "180°−θ の点は (−cosθ, sinθ)",
        note: "y軸対称なので x座標だけ符号が反転します。",
      },
      {
        expression: "sin(180°−θ)=sinθ, cos(180°−θ)=−cosθ",
        note: "それぞれ y座標と x座標を読みます。",
      },
      {
        expression: "tan(180°−θ)=sinθ/(−cosθ)=−tanθ",
        note: "tan=sin/cos を使うと tan の符号も分かります。",
      },
    ],
  },
  "tan-from-sin-cos": {
    ...
    steps: [
      {
        expression: "sinθ = 向かい側/斜辺, cosθ = となり側/斜辺",
        note: "三角比の定義を書きます。",
      },
      {
        expression: "sinθ/cosθ = (向かい側/斜辺)/(となり側/斜辺)",
        note: "sin を cos で割ります。",
      },
  ...
  "pythagorean-trig": {
    ...
    steps: [
      {
        expression: "a² + b² = c²",
        note: "向かい側を a、となり側を b、斜辺を c とした三平方の定理です。",
      },
  ...
  "sine-law": {
    ...
    steps: [
      {
        expression: "辺AB上へ C から高さ h を下ろす",
        note: "辺 a=BC、b=CA とし、角 A,B を使います。",
      },
      ...
      { expression: "b sin A = a sin B", note: "どちらも同じ高さ h なので等しいです。" },
      {
        ...
        note: "両辺を sinA·sinB で整理します。同様に別の高さを使えば c/sinC も同じ値だと分かります。",
      },
  ...
  "cosine-law": {
    title: "余弦定理の導出",
    introduction:
      "1つの頂点から高さを下ろし、底辺方向の長さを cos、垂直方向の長さを sin で表して三平方の定理を使います。",
    steps: [
      { expression: "C から AB へ高さを下ろす", note: "AB=c、AC=b、BC=a、角Aを基準にします。" },
      { expression: "底辺方向 = b cos A, 高さ = b sin A", note: "AC=b の水平成分と垂直成分です。" },
      {
        expression: "a² = (c − b cos A)² + (b sin A)²",
        note: "BCを斜辺とする直角三角形に三平方の定理を使います。",
      },
      { expression: "= c² − 2bc cos A + b²cos²A + b²sin²A", note: "平方を展開します。" },
      {
        expression: "= b² + c² − 2bc cos A",
        note: "sin²A+cos²A=1 を使って b²(cos²A+sin²A)=b² とまとめます。",
      },
    ],
  },
  "triangle-area": {
  ...
  "vertex-form": {
    ...
    steps: [
      ...
      {
        expression: "x=p±t では (x−p)²=t²",
        note: "pから左右へ同じ距離の点で y が同じなので、軸は x=p です。",
      },
    ],
  },
  "completing-square": {
    ...
    steps: [
      ...
      {
        expression: "x² + bx = (x + b/2)² − (b/2)²",
        note: "余分に加わった (b/2)² を引けば元の式になります。",
      },
    ],
  },
  "quadratic-extrema-all-real": {
    ...
    steps: [
      ...
      {
        expression: "a<0 なら a(x−p)² ≤ 0 → y≤q",
        note: "aが負なら同様に x=p で最大値 q になります。",
      },
    ],
  },
  "quadratic-roots-graph": {
    ...
    steps: [
      ...
      {
        expression: "f(x)=0 の実数解 = 交点の x座標",
        note: "このため方程式の解の個数と x軸との交点数が対応します。",
      },
    ],
  },
  "quadratic-formula": {
    ...
    steps: [
      ...
      {
        expression: "x² + (b/a)x + (b/2a)² = −c/a + (b/2a)²",
        note: "左辺を平方にするため同じ数を両辺へ加えます。",
      },
      {
        expression: "(x + b/2a)² = (b² − 4ac)/(4a²)",
        note: "左辺を平方完成し、右辺を通分します。",
      },
  ...
  discriminant: {
    ...
    introduction:
      "解の公式で実数として平方根を取れるかどうかは、根号の中 b²−4ac の符号だけで決まります。",
    steps: [
  ...
  "correlation-coefficient": {
    title: "相関係数の位置付け",
    introduction:
      "相関係数は、共分散を2つの標準偏差で割って尺度の影響を除くように定義します。値が −1 以上1以下になる完全な証明には、この段階では扱わない不等式を使うため、ここでは性質として利用します。",
    steps: [
      {
        expression: "r = 共分散/(xの標準偏差 × yの標準偏差)",
        note: "共分散をそれぞれの散らばりの大きさで標準化する定義です。",
      },
      {
        expression: "単位を変えても r は変わらない",
        note: "分子の尺度変化と分母の標準偏差の尺度変化が相殺されます。",
      },
      {
        expression: "−1 ≤ r ≤ 1",
        note: "この値域は相関係数の基本性質として使います。証明は数学Ⅰの学習目標を越えるためここでは扱いません。",
      },
    ],
  },
};
