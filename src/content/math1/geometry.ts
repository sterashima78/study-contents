    ...
    lessons: [
      {
        ...
        concepts: [
          {
            ...
            formulas: ["sin θ = 向かい側 / 斜辺", "cos θ = となり側 / 斜辺", "tan θ = 向かい側 / となり側"],
          },
        ],
        example: {
        ...
        summary: ["sin は向かい側/斜辺、cos はとなり側/斜辺、tan は向かい側/となり側。", "どの角を基準にするかで『向かい側』『となり側』が変わる。"],
      },
      {
        ...
        concepts: [
          {
            ...
            formulas: ["sin 30° = 1/2, cos 30° = √3/2, tan 30° = 1/√3", "sin 45° = cos 45° = 1/√2, tan 45° = 1", "sin 60° = √3/2, cos 60° = 1/2, tan 60° = √3"],
          },
        ],
        example: {
        ...
        summary: ["特別な角の値は、2つの基本三角形から作り直せる。", "丸暗記ではなく、辺の比と三角比の定義を組み合わせる。"],
      },
      {
        key: "obtuse-angle-trig",
        title: "鈍角の三角比",
        description: "0°から180°まで角を広げ、sin・cos・tan の符号を理解します。",
        goals: ["第2象限で sin は正、cos と tan は負になることを説明できる。", "180°−θ の三角比を鋭角 θ の値から求められる。"],
        concepts: [
          {
            title: "単位円で符号を見る",
            body: [
        ...
        practice: {
          ...
          steps: [
            ...
            { prompt: "tan 150° を求めてください。", answers: ["-1/√3", "−1/√3", "-√3/3", "−√3/3"] },
          ],
          hint: "第2象限では sin だけが正です。",
        },
        summary: ["90°<θ<180°では sin>0、cos<0、tan<0。", "180°−θ に直すと、鋭角の特別な値を利用できる。"],
      },
    ],
  },
  {
    ...
    lessons: [
      {
        ...
        concepts: [
          { title: "共通する斜辺を消す", body: ["sin と cos はどちらも斜辺を分母にもつため、sin÷cos を計算すると斜辺が消えます。"], formulas: ["tan θ = sin θ / cos θ"] },
        ],
        example: {
        ...
        practice: {
          ...
          steps: [
            { prompt: "tan θ を割り算の形で書いてください。", answers: ["(5/13)/(12/13)", "5/13÷12/13"] },
            { prompt: "tan θ を求めてください。", answers: ["5/12"] },
          ],
          hint: "tan=sin/cos なので、分母どうしの13が消えます。",
        },
        summary: ["tan θ は sin θ を cos θ で割ったもの。", "3つの三角比を別々の暗記事項にせず、定義から関係を作れる。"],
      },
      {
        key: "pythagorean-trig",
        title: "sin² θ + cos² θ = 1",
        description: "三平方の定理を辺の比で割り、三角比の基本関係を導きます。",
        goals: ["sin²θ+cos²θ=1 を三平方の定理から導ける。", "sin または cos の値から残りを求められる。"],
        concepts: [
          { title: "三平方の定理を斜辺²で割る", body: ["向かい側を a、となり側を b、斜辺を c とすると a²+b²=c² です。両辺を c² で割ると三角比の式になります。"], formulas: ["sin² θ + cos² θ = 1"] },
        ],
        example: {
        ...
        summary: ["sin²θ+cos²θ=1 は三平方の定理から得られる。", "平方根を取るときは角の範囲から符号を決める。"],
      },
      {
        key: "trig-from-one-ratio",
        title: "1つの三角比から残りを求める",
        description: "角の範囲と相互関係を組み合わせ、sin・cos・tan をそろえます。",
        goals: ["角の範囲から三角比の符号を決められる。", "基本関係を順に使って残りの三角比を求められる。"],
        concepts: [
          { title: "平方の式では符号が消える", body: ["sin²+cos²=1 から平方根を取ると ± が生じます。最後に角の範囲を見て正負を決めます。", "tan は sin/cos で求めると符号も自動的に確認できます。"] },
        ],
        example: {
        ...
        summary: ["平方根を取った後の符号は角の範囲で決める。", "sin と cos がそろったら tan=sin/cos を使う。"],
      },
    ],
  },
  {
    ...
    lessons: [
      {
        ...
        goals: ["a/sin A=b/sin B=c/sin C を説明できる。", "1組の辺と角から別の辺や角を求められる。"],
        concepts: [
          { title: "辺は向かい合う角の sin と対応する", body: ["三角形ABCで、辺a,b,cはそれぞれ角A,B,Cの向かい側です。対応を崩さず比例式を立てます。"], formulas: ["a/sin A = b/sin B = c/sin C"] },
        ],
        example: {
        ...
        practice: {
          ...
          steps: [
            { prompt: "比例式を書いてください。", answers: ["6/(1/2)=b/(√3/2)", "6/sin30=b/sin60"] },
            { prompt: "b を求めてください。", answers: ["6√3"] },
          ],
          hint: "b=6·sin60°/sin30° として計算できます。",
        },
        summary: ["正弦定理では、辺とその向かい合う角を必ず組にする。", "『辺と向かいの角』の組が1つ分かっていると使いやすい。"],
      },
      {
        key: "cosine-law",
        title: "余弦定理",
        description: "高さと射影を使って三平方の定理を整理し、3辺と1角の関係を導きます。",
        goals: ["a²=b²+c²−2bc cos A を図から説明できる。", "2辺とその間の角から残りの辺を求められる。"],
        concepts: [
          { title: "三平方の定理を一般の三角形へ広げる", body: ["角Aが90°なら cos A=0 なので、余弦定理は a²=b²+c² となり三平方の定理に一致します。"], formulas: ["a² = b² + c² − 2bc cos A"] },
        ],
        example: {
        ...
        summary: ["余弦定理は2辺とその間の角から残りの辺を求めるときに使える。", "90°では三平方の定理に戻る。"],
      },
      {
        key: "law-selection",
        ...
        concepts: [
          { title: "正弦定理は向かい合う組、余弦定理は3辺と1角", body: ["辺と向かいの角の組が1つあり、別の辺または角を求めたいなら正弦定理を候補にします。", "2辺とその間の角、または3辺が分かっているなら余弦定理を候補にします。"] },
        ],
        example: {
          title: "例題: 条件から定理を選ぶ",
        ...
        summary: ["既知量の配置を図に書くと定理を選びやすい。", "定理名を暗記するだけでなく、未知量を含む式が作れるか確認する。"],
      },
    ],
  },
  {
    ...
    lessons: [
      {
        ...
        concepts: [
          { title: "高さを sin で表す", body: ["辺cを底辺にすると、辺bの底辺に垂直な成分が高さ b sin A になります。"], formulas: ["S = (1/2)bc sin A"] },
        ],
        example: {
      ...
      },
      {
        ...
        concepts: [
          { title: "一度に全部求めようとしない", body: ["まず既知量だけで使える定理を選び、未知量を1つ増やします。その結果を次の式へ使います。", "角が2つ分かれば、最後の角は A+B+C=180° で求められます。"] },
        ],
        example: {
          ...
          steps: [
            ...
            { expression: "4/sin30° = b/sin60°", note: "a,A の組が分かっているので正弦定理を使います。" },
        ...
        summary: ["既知量だけで作れる式から未知量を1つずつ増やす。", "内角の和、正弦定理、余弦定理を必要に応じてつなぐ。"],
      },
      {
        key: "height-distance",
        title: "高さ・距離を三角比で測る",
        ...
        concepts: [
          { title: "測量では図を単純化する", body: ["水平距離と仰角が分かる高さの問題では、水平距離がとなり側、高さが向かい側になるため tan が直接使えます。", "観測点の高さがある場合は、最後にその高さを足します。"] },
        ],
        example: {
        ...
        summary: ["状況を直角三角形へ置き換える。", "求めたい辺と既知の辺がどの組かを見て sin・cos・tan を選ぶ。"],
      },
    ],
  },
];
